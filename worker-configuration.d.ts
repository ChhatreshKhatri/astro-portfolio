/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 8230f4930cc2cca36f01af6588de28ba)
// Runtime types generated with workerd@1.20260507.1 2026-05-09 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface Env {
		ASSETS: Fetcher;
		PUBLIC_API_URL: string;
		PUBLIC_visitsCounter: string;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PUBLIC_API_URL" | "PUBLIC_visitsCounter">> {}
}
